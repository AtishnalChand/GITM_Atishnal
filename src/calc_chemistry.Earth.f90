...
subroutine calc_chemistry(iBlock)
  ...
  use ModSources
  use ModInputs, only: &
    iDebugLevel, UseIonChemistry, UseNeutralChemistry, f107, DoCheckForNans, UseReactionRatePerturbations
  use ModConstants
  use ieee_arithmetic
  use ModReactionRatePerturb !!! Atishnal Chand 2026 - to use module ModReactionRatePerturb
